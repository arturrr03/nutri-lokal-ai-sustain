  ...
  return (
    <section className="py-6 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <a href="https://badanpangan.go.id/wiki/gerakan-penganekaragaman-konsumsi-pangan-beragam-bergizi-seimbang-dan-aman-b2sa" target="_blank" rel="noopener noreferrer">
          <InfoCard
        ...
        <a  href="https://ayosehat.kemkes.go.id/topik-az" target="_blank" rel="noopener noreferrer">
          <InfoCard
            title="Edukasi Gizi"
        ...
        <a href="https://www.halodoc.com/artikel/stunting-adalah-info-lengkap-dan-cara-mencegahnya" target="_blank" rel="noopener noreferrer">
          <InfoCard
            ...
            icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
